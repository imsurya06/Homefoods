...
import { PhoneCall, Award, Clock, Heart } from 'lucide-react';
import { BESTSELLERS, type BestsellerProduct, calculatePriceDetails, generateWhatsAppOrderUrl } from '../data/bestsellers';

export const CuratedProcessSection: React.FC = () => {
  // Store selected variant index for each bestseller product
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8">
            ...
            {/* Loose, Airy Bestsellers Product Presentation (3 Cards) */}
                    ...
                    <div className="flex flex-col justify-between grow w-full space-y-4">
                      ...
                      <div className="pt-2">
                        ...
                        >
                          ...
                          <span>Order {product.name.split(' ')[0]} via WhatsApp</span>
                        </a>
                      </div>
